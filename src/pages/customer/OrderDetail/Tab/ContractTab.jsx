...
export default function ContractTab() {
  ...
  const contract = {
    ...
    is_sign_by_a: true,
    is_sign_by_b: false,
    quote: "Dịch vụ thi công nội thất phòng ngủ...",
    ...
    <>
      ...
      <Box p={5} bgColor="white" boxShadow="md" borderRadius="10px">
        <Stack spacing={4}>
          ...
          {/* Báo giá hợp đồng (quote) */}
          <HStack>
            <Text fontWeight="500">Báo giá hợp đồng:</Text>
            <Text>{contract.quote || "Chưa có thông tin"}</Text>
          </HStack>
          ...
          <HStack>
            <Text fontWeight="500">Hoa hồng nền tảng:</Text>
            <Text>
              {contract.platform_commission
                ? `${contract.platform_commission} VND`
                : "0 VND"}
            </Text>
          </HStack>
